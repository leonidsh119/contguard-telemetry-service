...
import com.contguard.telemetry.server.service.ExactLocation15MinTelemetryMatcher;
...
public class TelemetryConfiguration {
    ...
    @Bean
    public ITelemetryMatcher getTelemetryMatcher() {
        return new ExactLocation15MinTelemetryMatcher();
    }
}
